object Versions {
    ...
    const val ROOM_RUN = "2.2.6"
    const val NAVIGATION_COMPONENT = "2.5.0-alpha01"
...
object AndroidX {
    ...
    const val ROOM_RUNTIME = "androidx.room:room-runtime:${Versions.ROOM_RUN}"
...
object Network {
    ...
    const val RETROFIT_CONVERTER_SCALARS = "com.squareup.retrofit2:converter-scalars:${Versions.RETROFIT}"
...
object Reactivex {
    ...
    const val RX_ADAPTER = "com.squareup.retrofit2:adapter-rxjava2:2.8.1"
